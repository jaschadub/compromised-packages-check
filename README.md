...
| Woodpecker PyPI infostealer campaign — June 6–7 2026 (OSV MAL-2026-5274 through MAL-2026-5285, MAL-2026-5290, MAL-2026-5294) | Fourteen packages with specific versions compromised (twelve disclosed June 6, two more June 7): `dynamo-release` 1.5.4; `napari-ufish` 0.0.2, 0.0.3; `nucbox` 0.1.2, 0.1.3; `pantheon-toolsets` 0.5.5, 0.5.6; `spateo-release` 1.1.2; `uprobe` 0.1.3, 0.1.4; `bramin` 0.0.3, 0.0.4; `executor-http` 0.1.3, 0.1.4; `mrbios` 0.1.1, 0.1.2; `okite` 0.0.7, 0.0.8; `synago` 0.1.1, 0.1.2; `ufish` 0.1.2, 0.1.3; `cmd2func` 0.2.2, 0.2.3 (MAL-2026-5290); `magique-ai` 0.4.5 (MAL-2026-5294) — each ships a heavily obfuscated JS payload executed via Bun runtime on Python startup; collects API keys, registry credentials, crypto wallet keystores, and password-manager data; exfiltrates via GitHub; attempts persistence and self-propagation by republishing infected packages using stolen credentials; related to the Mini Shai Hulud campaign; detected by kam193/bad-packages.eu |
