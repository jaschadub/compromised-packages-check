...
- [OSV npm bulk export — full MAL-* dataset (July 26–27 2026 snapshot)](https://osv-vulnerabilities.storage.googleapis.com/npm/all.zip)
- [OSV PyPI bulk export — full MAL-* dataset (July 26–27 2026 snapshot)](https://osv-vulnerabilities.storage.googleapis.com/PyPI/all.zip)
