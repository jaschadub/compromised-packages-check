...
| July 2 2026 npm malware batch — Amazon Inspector / GHSA (OSV MAL-2026-4681/5604/6142/6495/6538/6725/6726/6727) | `tailwind-typography-stylecss` any-version (GHSA-p258-w6jm-c6ff); `cache-section-helper` any-version (GHSA-wg39-m2jm-wxhp); `db-connector-log` any-version (GHSA-w7hw-9wmw-hj5w); `animatecss-postcss-plugin` any-version (GHSA-p6ch-cw7w-ff5c); `db-plog` any-version (GHSA-j49r-84jx-vq3m); `@modhamanish/rn-mm-template` 1.1.3 (GHSA-7v96-p295-826q); `db-convertor` any-version (GHSA-p467-3jcx-48q5); `tailwind-animates` any-version (GHSA-3cr6-gpr8-pjfm) — infostealers and credential-exfiltration payloads detected by Amazon Inspector |
| Epic Games / Unreal Engine dep-confusion campaign — July 2 2026 (OSV MAL-2026-6729/6730/6731/6732/6733/6734/6735/6736/6737) | npm: `robomerge` 99999.0.0; `ue-automation-scripts` 99999.0.0; `ue-jenkins-buildkite` 99999.0.0; `unreal-horde-dashboard` 99999.0.0; `epic-internal-tools` 99999.0.0 — PyPI: `epic-build-scripts` 99999.0.0; `horde-python-client` 99999.0.0; `ue-python-tools` 99999.0.0; `unreal-mladapter` 99999.0.0 — nine packages published at inflated 99999.0.0 versions to shadow Epic Games / Unreal Engine internal CI dependencies; detected by kam193 |
| dt-validator PyPI malware — July 2 2026 (OSV MAL-2026-6728) | `dt-validator` 0.3.0 — malicious code detected by kam193; single version published before takedown |
