...
| @wagni_bot DeFi / crypto-stealer npm cluster — July 9 2026 (OSV MAL-2026-10022 through MAL-2026-10037) | 16 packages across the `@wagni_bot/` npm scope impersonating popular blockchain / DeFi SDKs: `@wagni_bot/binance-sdk` 1.0.0/1.2.0; `@wagni_bot/bsc-sdk` 7 versions; `@wagni_bot/eth-agent` 7 versions; `@wagni_bot/ethereum-wallet` 1.0.0/1.2.0; `@wagni_bot/hyperliquid-sdk` 7 versions; `@wagni_bot/jupiter-sdk` 1.0.0/1.2.0; `@wagni_bot/metemask-sdk` 7 versions; `@wagni_bot/meteora-sdk` 1.0.0/1.2.0; `@wagni_bot/opensea-sdk` 7 versions; `@wagni_bot/orca-sdk` 1.0.0/1.2.0; `@wagni_bot/polygon-sdk` 7 versions; `@wagni_bot/polymarket-sdk` 7 versions; `@wagni_bot/pumpfun-sdk` 1.0.0/1.2.0; `@wagni_bot/solana-sdk` 1.0.0/1.2.0; `@wagni_bot/web3-agent` 6 versions; `@wagni_bot/web3-toolkit` 1.0.0/1.2.0 — postinstall payloads steal wallet keys, API credentials, and session tokens |
| chai-as-* / chain-chai-* typosquat cluster extension — July 9 2026 | 52 npm packages extending the ongoing Chai typosquat campaign: `chai-as-absorbed` 3.4.1; `chai-as-adapter`, `chai-as-buffer`, `chai-as-chain-v2`, `chai-as-char`, `chai-as-elevated`, `chai-as-encrypted`, `chai-as-evm`, `chai-as-float`, `chai-as-inserted`, `chai-as-mobj`, `chai-as-redeployed`, `chai-as-refined`, `chai-as-streamed`, `chai-as-type`, `chai-as-vec`, `chai-beta`, `chai-str`, `chai-use-chain`, `chai-use-chains`, `chain-promised-await` (all any-version wildcards); `chai-as-align` 7.1.0; `chai-as-balanced` 2.2.3; `chai-as-belonged` 4.3.8; `chai-as-buffered` 3.7.24; `chai-as-chains` 3 versions; `chai-as-commited` 2 versions; `chai-as-consisted` 2.2.9; `chai-as-disarmed` 3.2.3; `chai-as-informed` 1.2.0; `chai-as-launched` 3.51.1; `chai-as-legit` 7.2.3; `chai-as-modified` 6.0.4; `chai-as-patched` 2 versions; `chai-as-purified` 7.1.1; `chai-as-sai` 2.3.5; `chai-as-serialized` 7.0.8; `chai-as-sharpened` 7.0.9; `chai-as-smart` 2.3.5; `chai-as-staged` 6.0.4; `chai-as-test` 1.2.9; `chai-as-thread` 7.0.8; `chai-as-upgraded` 7.0.5; `chai-await-dom` 1.3.7; `chai-defender` 6 versions; `chai-deflect` 2 versions; `chai-promised-test` 1.3.5; `chai-secure` 2 versions; `chai-smart` 2.3.5; `chain-async-dom` 1.3.6; `chain-chai-async` 1.3.5; `chain-chai-await` 3 versions — OSV MAL-2026-1320/2339/2641/2740/2743/2885–2899/3164/3165/3657/4168/4292/4293/7230–7241/10039–10056/10082 |
| polymarket-* npm typosquat extension — July 9 2026 (OSV MAL-2026-1463/10067–10072) | 7 packages extending the polymarket credential-exfiltration campaign: `polymarket-apis` 1.1.0; `polymarket-kelly-math` 3.5.2; `polymarket-kelly-maths` 3.5.3; `polymarket-kelly-stake-math` 3.6.1; `polymarket-kit` 2.4.1; `polymarket-trader-apis` 0.1.0/2.1.0; `polymarket-validator` (any-version) |
| Proton AG dep-confusion npm wave — July 9 2026 (OSV MAL-2023-1273/1274) | `proton-account` 99.99.99/99.99.999/99.99.9999 (high-version dep-confusion targeting Proton AG internal CI); `proton-pack` any-version wildcard |
| MoonBit impersonation PyPI cluster — July 9 2026 (OSV MAL-2026-2945/2946/2947) | `moonbit-locale-compat` 0.2.1/0.2.3/0.2.4; `moonbit-metrics-validator` 1.0.0; `moonbit-schema-utils` 1.1.0/1.1.1 — three packages impersonating the MoonBit language tooling ecosystem with install-time credential-exfiltration payloads |
| Playwright PyPI typosquat — July 9 2026 (OSV MAL-2026-10020) | `playwrightr` 1.0.0/1.0.1 — typosquat of the Playwright browser-automation library |
| Telegram credential-stealer PyPI cluster — July 9 2026 (OSV MAL-2026-5531/6051) | `telegramlite` 1.0.0/1.0.1; `telegram-lite-grabber` 1.0.0 — two packages impersonating Telegram API client libraries; exfiltrate session tokens and credentials |
| Crypto / Web3 PyPI malware cluster — July 9 2026 (OSV MAL-2026-7458/7465/3411) | `pycryptoshuffle` 1.0.6/1.0.7; `quatre` 3.0.0; `web3-py-checksum` 1.0/1.1 — crypto-wallet-focused packages stealing API keys and wallet credentials |
| Miscellaneous PyPI malware batch — July 9 2026 | `d0rk3r` 16 versions (1.0.0–1.2.0); `security-alerts-sdk` 1.0.0–1.0.3; `nagios-xi` 19.4.0/19.5.0; `proxy-check-i` 0.1.0/0.1.1; `sufiagent` 1.0.0–1.0.2; `cache-compat-utils` 0.1.0; `qlinforge` 0.3.2; `piirgg` 0.2/0.3/0.4/0.6; `notrandompacketname` 0.1.10–0.1.12; `scan-checker` 0.1.0; `scanvia` 0.1.1; `pwn-control` 1.0; `temp-development-package-test` 0.1–0.4; `myproject234` 0.1; `cyberday26szymon-auth/logging/payments` 0.0.1 — OSV MAL-2026-3248/3370/5698/5876/5878/6246/6327/7452–7454/7455–7458/7459–7467/10091/10100 |
| GremlinBox malware-simulation PyPI cluster — July 9 2026 (OSV MAL-2026-7459 through MAL-2026-7464) | `pygremlinbox-malware-c2-beacon`, `pygremlinbox-malware-code-obfuscation`, `pygremlinbox-malware-credential-harvesting`, `pygremlinbox-malware-cryptomining-indicators`, `pygremlinbox-malware-install-execution`, `pygremlinbox-malware-network-indicators` — all version 2.0.0; packages with explicit malware-simulation names that nonetheless contain confirmed active malicious payloads (classified MALICIOUS by ossf/malicious-packages) |
...
- [OSV MAL-2026-10022 through MAL-2026-10037 — @wagni_bot DeFi/crypto-stealer npm cluster (July 9 2026)](https://osv.dev/vulnerability/MAL-2026-10022)
- [OSV MAL-2026-10039 through MAL-2026-10056, MAL-2026-10082 — chai-as-*/chain-chai-* typosquat cluster extension (July 9 2026)](https://osv.dev/vulnerability/MAL-2026-10039)
- [OSV MAL-2026-1320/2339/2641/2740/2743/2885–2899/3164/3165/3657/4168/4292/4293/7230–7241 — chai-as-* earlier records (updated July 9 2026)](https://osv.dev/vulnerability/MAL-2026-7230)
- [OSV MAL-2026-1463/10067–10072 — polymarket-* npm typosquat extension (July 9 2026)](https://osv.dev/vulnerability/MAL-2026-10067)
- [OSV MAL-2023-1273/1274 — proton-account/proton-pack dep-confusion (July 9 2026)](https://osv.dev/vulnerability/MAL-2023-1273)
- [OSV MAL-2026-2945/2946/2947 — moonbit-* PyPI impersonation cluster (July 9 2026)](https://osv.dev/vulnerability/MAL-2026-2945)
- [OSV MAL-2026-10020 — playwrightr PyPI typosquat (July 9 2026)](https://osv.dev/vulnerability/MAL-2026-10020)
- [OSV MAL-2026-5531/6051 — Telegram credential-stealer PyPI cluster (July 9 2026)](https://osv.dev/vulnerability/MAL-2026-5531)
- [OSV MAL-2026-7458/7465/3411 — crypto/Web3 PyPI malware cluster (July 9 2026)](https://osv.dev/vulnerability/MAL-2026-7458)
- [OSV MAL-2026-3248/3370/5698/5876/5878/6246/6327/7452–7467/10091/10100 — miscellaneous PyPI malware batch (July 9 2026)](https://osv.dev/vulnerability/MAL-2026-6246)
- [OSV MAL-2026-7459 through MAL-2026-7464 — pygremlinbox malware-simulation PyPI cluster (July 9 2026)](https://osv.dev/vulnerability/MAL-2026-7459)
- [OSV PyPI bulk export — full MAL-* dataset (July 9 2026 snapshot)](https://osv-vulnerabilities.storage.googleapis.com/PyPI/all.zip)
- [OSV npm bulk export — full MAL-* dataset (July 9 2026 snapshot)](https://osv-vulnerabilities.storage.googleapis.com/npm/all.zip)
