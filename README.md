...
| Misc npm typosquat / malware batch — Apr–Jun 2026 (OSV records updated July 7 2026) | 9 packages whose OSV MAL records were first ingested or materially updated July 7 2026: `@aspect-security/argon2` (MAL-2026-2505/GHSA-4fc4-v9cp-846x); `harmony-enablers-test-2026` (MAL-2026-4251/GHSA-ghw7-gg88-gpmr); `@43uh3ig43/telemetry-client` (MAL-2026-4252/GHSA-hqc4-gwfr-49r6); `@engagehub/core` (MAL-2026-4258/GHSA-5hgc-pmxv-3xh7); `tailwind-animator-scroll` (MAL-2026-5618/GHSA-mx93-wj6x-87wp); `warp-dependency` (MAL-2026-5724/GHSA-gxc9-xrxm-w788); `@apexcraft/nano-key` (MAL-2026-6210/GHSA-8x7w-vjr2-7q4m); `syco1` (MAL-2026-6404/GHSA-9mh8-xw8w-jh9g); `tailwindcss-effector` (MAL-2026-6472/GHSA-5xpc-q26w-px3q) — all any-version wildcards (ranges >=0) |
| July 7 2026 npm batch — multi-campaign (52 packages) | **Chai typosquats:** `chai-spycore` (GHSA-w3fq-7xj5-8gmv), `chai-chain-dom` (GHSA-2gcw-jv94-7mfq), `chai-sdk` (GHSA-xc9r-f5wv-cvxx); **Express typosquats:** `express-deflect` (GHSA-968w-6262-r9f5), `express-firegate` (GHSA-59r7-h2ch-m4v2); **@engagehub follow-up:** `@engagehub/test-claim` (GHSA-q6cv-rc8j-6pp7); **Dep-confusion probes:** `zluri-ad-connector` 9.9.9, `@higherlogic/ocfe` 99.9.1; **Fake @sqlite-access / @sqlite-list scope:** `@sqlite-access/nodesql` (GHSA-m2mh-6v6x-qh4f), `@sqlite-list/createsql` (GHSA-www8-7fg3-xg79), `@sqlite-list/schema-generator` (GHSA-2859-847v-c4v9), `@sqlite-list/sql-creator` (GHSA-9hmc-5fx9-73cp); **Base58/Solana cluster:** `base58-cli`, `crypto-base58`, `typescript-base58`, `solana-address-codec`; **MCP/utils cluster:** `jsf-utils`, `mcp-server-pg`, `notifier-utils`; **whs4 name-squatting cluster:** `@whs4/whs4_npm`, `whs4_nmp`, `whs4_npm`, `whs4_npm_test`, `whs4_pnm`, `wsh4_npm`; **Misc typosquats:** `brunomenozzi-test-pkg`, `annotator-harvardx`, `evm-typechain`, `hook-augmenting-module`, `load-nuxt`, `load-nuxt-dev`, `nonexistent-package`, `nuxt-fonts-devtools`, `pinokio-redis`, `polytrade`, `rnx-align-deps`, `shopify-internel`, `some-theme`, `tx-guard-snap`, `zredis-typed`, `paperclip-host-utils`, `runtimedev-link`, `vps-adapter-core`; **Dep-confusion probes:** `hello244b` 1.0.0, `rio-design-tokens` 99.99.100; **nodemon/ts-await typosquats (July 8):** `nodemon-node` (GHSA-58j3-rgh4-9rjc), `ts-await` (GHSA-xpmf-x27p-9vcc) |
| Paysafe payment-SDK PyPI typosquat campaign — July 7 2026 (OSV MAL-2026-6926/6927/6928/6929) | `paysafe-api` 1.0.0; `paysafe-kyc` 1.0.0; `paysafe-payments` 1.0.0; `paysafe-sdk` 1.0.0 — four packages impersonating the Paysafe payments SDK with identical malicious install-time code; detected by kam193 and Socket Threat Research Team |
| jsonschemavalidation PyPI malware — July 7 2026 (OSV MAL-2026-6945) | `jsonschemavalidation` 4.26.0 — single malicious version detected by kam193/bad-packages.kam193.eu |
| proton-pfff crates.io dep-confusion probe — July 8 2026 (OSV MAL-2026-6959) | `proton-pfff` 99.99.5 — high-version package published to shadow internal dependency resolution; single version before registry takedown |
