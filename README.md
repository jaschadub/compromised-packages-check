...
| @redhat-cloud-services scope account compromise — June 1 2026 | 16 `@redhat-cloud-services/*` npm packages (expanded from original 9 as additional malicious versions were published): `chrome` 2.3.1, 2.3.2, 2.3.4 (GHSA-942v-f47r-w9c3); `eslint-config-redhat-cloud-services` 3.2.1 (GHSA-c3mv-fjj4-2542); `entitlements-client` 4.0.12, 4.0.14 (GHSA-28hc-2275-h287); `frontend-components` 7.7.2 (GHSA-mrgj-mcjh-5mf2); `frontend-components-config` 6.11.4, 6.11.6 (GHSA-h43w-g623-gfmv); `frontend-components-config-utilities` 4.11.2, 4.11.3, 4.11.5 (GHSA-cxfw-p322-rfrv); `frontend-components-remediations` 4.9.3, 4.9.5 (GHSA-4rjr-7qhx-vjwg); `frontend-components-testing` 1.2.2 (GHSA-wgvx-w8g7-vh4h); `hcc-feo-mcp` 0.3.2, 0.3.4 (GHSA-vgm5-jmvr-cjgf); `integrations-client` 6.0.5, 6.0.7 (GHSA-8x4g-q845-wpfc); `quickstarts-client` 4.0.11 (GHSA-mj98-cgm5-6xrr); `rbac-client` 9.0.3, 9.0.4, 9.0.6 (GHSA-2p99-xvqh-j893); `rule-components` 4.7.2 (GHSA-c4gm-6fh3-76v9); `sources-client` 3.0.11, 3.0.13 (GHSA-vp9c-9mjm-2f7w); `topological-inventory-client` 3.0.10, 3.0.11, 3.0.13 (GHSA-9wp8-557p-2hvf); `types` 3.6.1 (GHSA-8xj2-9c64-m64h); OSV MAL-2026-5111 through MAL-2026-5119, 5125–5131; scope added to NPM_SUSPECT_SCOPES |
