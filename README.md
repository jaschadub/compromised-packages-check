...
| @polka-ui/config dependency-confusion — May 27 2026 (MAL-2026-4834) | `@polka-ui/config` 9.9.11 (npm) — high-version package published to shadow a private internal package in CI; executes malicious commands on install |
| Roblox/robase developer-tool credential-stealer cluster — May 2026 | 52 PyPI packages targeting Roblox game developers: `robase` family (18 packages: `robase`, `robase-api`, `robase-apis`, `robase-app`, `robase-dnb`, `robase-fallback`, `robase-fast-install`, `robase-gui`, `robase-gui-api`, `robase-help`, `robase-install`, `robase-installer`, `robase-library-quick-install`, `robase-quick-install`, `robase-setup`, `robase-start`, `robase-ui`, `robase-utils`); `rblx-*` / `ro-*` (8 packages: `rblx-api`, `rblx-http`, `rblx-https`, `rblx-studio-api`, `ro-db`, `roboat-addition`, `roboat-additions`, `roboat-utilities`, `roboat-utils`, `roboats-addition`); `rogiant` (3 packages); `database*` / Roblox (11 packages: `database-roblox`, `databaselooks`, `databasenaps`, `databaseroboat`, `databaseroboats`, `databaserobooms`, `databaserotacos`, `databasesupalake`, `databasesupasafe`, `databasetapes`, `databasetrace`); misc (`api-analysis`, `api-feature`, `bloxy-api`, `core-roblox-utils`, `pycolorlib001`, `pycolorlib3`, `quicksolving`, `quicktestybesty`, `rosolver`, `rostilesolver`) |
...
- [OSV MAL-2026-4834 — @polka-ui/config dependency-confusion](https://osv.dev/vulnerability/MAL-2026-4834)
- [OSV MAL-2026-2279 — roboat-addition (Roblox cluster)](https://osv.dev/vulnerability/MAL-2026-2279)
- [OSV MAL-2026-2512 — roboat-utils (Roblox cluster)](https://osv.dev/vulnerability/MAL-2026-2512)
- [OSV MAL-2026-2543 — robase (Roblox cluster)](https://osv.dev/vulnerability/MAL-2026-2543)
- [OSV MAL-2026-2864 — robase-setup (Roblox cluster)](https://osv.dev/vulnerability/MAL-2026-2864)
- [OSV MAL-2026-2863 — rblx-studio-api (Roblox cluster)](https://osv.dev/vulnerability/MAL-2026-2863)
- [OSV MAL-2026-4835 — rogiant-install (Roblox cluster)](https://osv.dev/vulnerability/MAL-2026-4835)
